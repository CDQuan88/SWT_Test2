                                    ...
                                    <div class="row g-0">
                                        <div class="col-lg-6">
                                            <div class="p-5">
                                                ...
                                                <h5 style="color: red">${requestScope.mess1}</h5>
                                                <div class="row">
                                                    <div class="col-md-6 mb-4 pb-2 mb-md-0 pb-md-0">

                                                        <div class="form-outline">
                                                            <label class="" for="form3Examplev4">Re-Password</label>
                                                            <input name="repassword" minlength="6" required style="border: solid #ebebeb 3px; width: 400px; border-radius: 30px" type="password" id="form3Examplev4" class="form-control form-control-lg" />
                                        ...
                                        <div class="col-lg-6 bg-indigo text-white">
                                            <div class="p-5">
                                                ...
                                                <div class="mb-4 pb-2">
                                                    <div class="form-outline form-white">
                                                        <label class="" for="form3Examplea4">Câu hỏi bảo mật:</label>
                                                        <select name="check">
                                                            <c:forEach items="${sessionScope.listCheck}" var="i">
                                                                <option value="${i.getCheck_id()}">${i.getCheck_question()}</option>  
                                                            </c:forEach>
                                                        </select>
                                                        <input name="answer" required style="border: solid white 1px; width: 400px; border-radius: 30px" type="text" id="form3Examplea4" class="form-control form-control-lg" placeholder="Answer question" />
                                                    </div>
                                                </div>
