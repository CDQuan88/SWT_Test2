                        ...
                        <tbody class="table">
                            ...
                            <c:forEach items="${sessionScope.Cart}" var="cart" varStatus="loop">
                                <tr class="table-primary">
                                    ...
                                    <th>${sessionScope.listProduct.getProductName()}</th>
                                    <th><img src="${sessionScope.listProduct.getImg()}" width="200" height="200" style="border-radius: 15px;" alt="alt"/></th>
                                    <th><p style="color: red">1</p> (Hiện có: ${sessionScope.listProduct.getQuantity()})</th>
                                   
                                    <th>${helper.convertBigNum(1*cart.getPrice())}</th>
                                    
                                    <th><a href="cart?aid=${cart.getAccount_id()}&pid=${cart.getProduct_id()}&buy=1"><button style="background-color: greenyellow" type="button" class="btn">Buy</button></a></th>
                                    <th><a href="cart?aid=${cart.getAccount_id()}&pid=${cart.getProduct_id()}&del=1"><button style="background-color: greenyellow" type="button" class="btn">Delete</button></a></th>
                                </tr>
                            </c:forEach>
                        </tbody>
                    ...
                    <div class="row m-3">
                        <div class="col-md-12 bg-light text-right">
                            ...
                            <c:forEach var="cart" items="${sessionScope.Cart}">
                                <c:set var="total" value="${total + 1*cart.getPrice()}" />
                            </c:forEach>
                    ...
                    <div class="row">
                        <div class="col-md-12 bg-light text-right">
                            <form id="frmAll" action="cart" method="get">
                                ...
                                <input hidden name="pid" value="${sessionScope.Cart.get(0).getAccount_id()}">
                            </form>
                        </div>
                    </div>
                </c:if>
                            ...
                            <div class="card-body mx-4">
                                <div class="container">
                                    ...
                                    <c:forEach items="${sessionScope.Cart}" var="cart">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-10">
                                                <p>${1} ${cart.getProductName()}</p>
                                            </div>
                                            <div class="col-xl-2">
                                                <p class="float-end">${helper.convertBigNum(1*cart.getPrice())} </p>
                                            </div>
